...
const Auth = () => {
  ...
  const handleShowPassword = () => setShowPass((prevShowPass) => !prevShowPass);
    ...
    <Container component="main" maxWidth="xs">
      <Paper elevation={3} className={classes.paper}>
        ...
        <form className={classes.form} onSubmit={handleSubmit}>
            <Grid container spacing={2}>
                {
                  ...
                  <Input name ="email" label="Email Address" handleChange={handleChange} type="type" fullWidth />
            ...
            <GoogleLogin 
            clientId="102111847291-nppr4plrno6ko03l6sdra2rltklbvr6f.apps.googleusercontent.com"
            render={(renderProps)=>(
                <Button 
